...
class SpeechBubbleShapeRight(
    ...
    override fun createOutline(
        ...
        val path = Path().apply {
            ...
            moveTo(size.width - tipSize, size.height - tipSize - cornerRadius)
            lineTo(size.width-tipSize, size.height-cornerRadius)
            lineTo(size.width
                , size.height - tipSize)
            close()
        }
